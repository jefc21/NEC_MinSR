...
SOURCES = \
	__init__.py \
	eutrophication.py eutrophication_dialog.py

PLUGINNAME = eutrophication

PY_FILES = \
	__init__.py \
	eutrophication.py eutrophication_dialog.py

UI_FILES = eutrophication_dialog_base.ui
...
QGISDIR=C:\Users\ericc\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
